...
3. Create a project folder called **_3d_model_yourstudentID_**

4. Create concept sketches for front, side, and top views.

    1. [Download the sketch sheet](https://drive.google.com/file/d/0BzXX6rmROMNWYThXbkNIRl9XblU/view?usp=sharing)

    2. Save as **_3d_model_concept_front_yourstudentID.jpg, 3d_model_concept_side_yourstudentID.jpg, 3d_model_concept_top_yourstudentID.jpg _**in your project folder.

5. Create a polygonal model of a based on your concept sketches

    3. Save Maya scene as **_3d_model_yourstudentID.mb_**

6. Compress(zip) the project folder once you’ve completed the tutorial and rename it **_3d_model_yourstudentID.zip_**

7. Upload the .zip file to the [3D Modeling Dropbox](https://psu.box.com/signup/collablink/d_4284118015/11f1d5e0653db7)

8. Post a screenshot of your model to **Lore** → **Discussion**
